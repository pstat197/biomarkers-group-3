...
```
We can also observe how the outliers effect each of the protein's mean values in the table below, which is ordered from the highest to lowest change in mean from including and excluding outliers.
